...
parser = argparse.ArgumentParser(
    description=
    "Generate C and S header files from a Softhier configuration file.")
parser.add_argument("input_file",
                    nargs="?",
                    default="pulp/pulp/chips/softhier/softhier_arch.py",
                    help="Path to the input Python file")
parser.add_argument(
    "C_header_file",
    nargs="?",
    default="pulp/pulp/chips/softhier/sw/runtime/include/softhier_arch.h",
    help="Path to the C header file")
parser.add_argument(
    "S_header_file",
    nargs="?",
    default="pulp/pulp/chips/softhier/sw/runtime/include/softhier_arch.inc",
    help="Path to the S header file")
args = parser.parse_args()
input_file = args.input_file
C_header_file = args.C_header_file
S_header_file = args.S_header_file
